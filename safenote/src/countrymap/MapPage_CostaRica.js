...
export default function MapPage_CostaRica()
{   
    ...
    React.useEffect(()=>{
        const fetchItemList = async () => {
            try {
                ...
                const response_getembassy = await API.get("embassy/?na=코스타리카");
                const response_getmedical = await API.get("medical/?na=코스타리카");
