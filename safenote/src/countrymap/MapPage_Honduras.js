...
export default function MapPage_Honduras()
{   
    ...
    React.useEffect(()=>{
        const fetchItemList = async () => {
            try {
                ...
                const response_getembassy = await API.get("embassy/?na=온두라스");
                const response_getmedical = await API.get("medical/?na=온두라스");
