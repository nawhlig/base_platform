...
export default function MapPage_NewZealand()
{   
    ...
    React.useEffect(()=>{
        const fetchItemList = async () => {
            try {
                ...
                const response_getembassy = await API.get("embassy/?na=뉴질랜드");
                const response_getmedical = await API.get("medical/?na=뉴질랜드");
