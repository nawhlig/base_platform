...
export default function MapPage_Philippines()
{   
    ...
    React.useEffect(()=>{
        const fetchItemList = async () => {
            try {
                ...
                const response_getembassy = await API.get("embassy/?na=필리핀");
                const response_getmedical = await API.get("medical/?na=필리핀");
