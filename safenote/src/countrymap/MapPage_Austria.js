...
export default function MapPage_Austria()
{   
    ...
    React.useEffect(()=>{
        const fetchItemList = async () => {
            try {
                ...
                const response_getembassy = await API.get("embassy/?na=오스트리아");
                const response_getmedical = await API.get("medical/?na=오스트리아");
