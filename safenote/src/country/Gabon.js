...
function Gabon()
{
    ...
    React.useEffect(()=>{
        const fetchItemList = async () => {
            try {
                ...
                const response_helpcall = await API.get("helpcall/?na=가봉");
    ...
    return(
        <>
            <div className='countryheader'>Gabon</div>
            <div className='sosbox'>
                ...
                <Link exact to='/gabonmap'><button className='btn4'><img className="btnicon" src={map}/><br/>Map</button></Link>
            </div>
        </>
    )
