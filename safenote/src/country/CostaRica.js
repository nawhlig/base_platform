...
function CostaRica()
{
    ...
    React.useEffect(()=>{
        const fetchItemList = async () => {
            try {
                ...
                const response_helpcall = await API.get("helpcall/?na=코스타리카");
    ...
    return(
        <>
            <div className='countryheader'>CostaRica</div>
            <div className='sosbox'>
                ...
                <Link exact to='/costaricamap'><button className='btn4'>Map</button></Link>
            </div>
        </>
    )
