...
function Oman()
{
    ...
    React.useEffect(()=>{
        const fetchItemList = async () => {
            try {
                ...
                const response_helpcall = await API.get("helpcall/?na=오만");
    ...
    return(
        <>
            <div className='countryheader'>Oman</div>
            <div className='sosbox'>
                ...
                <Link exact to='/omanmap'><button className='btn4'><img className="btnicon" src={map}/><br/>Map</button></Link>
            </div>
        </>
    )
